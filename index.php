        ...
        <div class="container">
            <p class="text-center mt-5">Bienvenue sur le site de Backtovalues.fr, <br>un site qui a vocation de vous apprendre à prendre les bonnes décisions pour une vie plus heuseuse. </p>
                ...
                <div class="container">
                    ...
                    <h3 class="mt-4 ml-3">A la une, aujourd’hui</h3>
                    <hr class="mb-5">
                    ...
                    <div class="row mx-auto">
                        <div class="col-md-6 col-lg-8 mt-3"> 
                            ...
                            <?php 
                                    $statement = $db->query('SELECT * FROM items ORDER BY id DESC LIMIT 2');
                            ...
                            ?>
                                ...
                                <h4 class="card-title"><?= $item['title']; ?></h4><hr>
            ...
            <div class="container">
                <hr class="mt-5 border--trans">
                <h3 class="mt-4 ml-3">Manipulation</h3>
                <hr class="mb-5"> 
            
                <div class="row mx-auto">

                <?php 
                    $statement = $db->query('SELECT * FROM items WHERE category = 2 ORDER BY id DESC LIMIT 3');
            ...
            <div class="container">
                ...
                <?php 
                    $statement = $db->query('SELECT * FROM items WHERE category = 3 ORDER BY id DESC LIMIT 3');
                    foreach($statement as $item) {
                ?>
